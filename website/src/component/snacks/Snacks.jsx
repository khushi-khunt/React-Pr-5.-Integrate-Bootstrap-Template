                        ...
                        <div className="col-12 d-flex flex-wrap justify-content-center">
                            <div className="col-12 col-md-6 col-lg-4 p-2">
                                <div className="banner card">
                                    <img src="image/s1.jpg" className="card-img-top" alt="..." />
                                    <div className="col-8 banner-body card-body  ">
                                        <h5>Healthy<br></br> Bakery Products</h5>
                                        <p><span className='fs-4 sp pe-1'>30%</span> off <span>on first order</span> </p>
                                        <div className="ShopBtn d-flex"> <a href="#" className="btn fs-6">shop Now</a></div>
                                        </div>
                                </div>
                            </div>
                            <div className="col-12 col-md-6 col-lg-4 p-2">
                                <div className="banner card">
                                    <img src="image/s4.jpg" className="card-img-top" alt="..." />
                                    <div className="col-8 banner-body card-body  ">
                            ...
                            <div className="col-12 col-md-6 col-lg-4 p-2">
                                <div className="banner card">
                                    <img src="image/s3.jpg" className="card-img-top" alt="..." />
                                    <div className="col-8 banner-body card-body  ">
