                                        ...
                                        <div className="col-12 col-md-6 col-lg-4 p-2 " key={n.id}>
                                            <div className="news-card card">
                                                ...
                                                <div className="news-body card-body">
                                                    ...
                                                    <p className="card-text pt-2 fw-bold" style={{ color: "#000" }}>{n.content}</p>
                                                    <a href="#" className="btn p-0 fw-bold fs-6 ">{n.btn}<span><FaArrowRight /></span>
                                                    </a>
                                                </div>
                                                ...
                                                <div className="img">
                                                    <img src={n.img} className="card-img-top" alt="..." />
